...
export const cart = () => {
  ...
  return (
    /*HTML*/
    `<div id="cart" class="cart-modal cart-modal-overlay flex min-h-full items-end justify-center p-0 sm:items-center sm:p-4 fixed left-0 top-0 w-full h-full z-[9999]">
